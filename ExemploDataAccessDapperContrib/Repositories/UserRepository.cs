    ...
    public class UserRepository
    {
        ...
        public long InsertUser(User user)
        {
            try
            {
                ...
                return _sqlConnection.Insert<User>(user);
            }
            catch (Exception ex)
            {
                return 0;
        ...
        public bool UpdateUser(User user)
        {
            try
            {
                ...
                return _sqlConnection.Update<User>(user);
            }
            catch (Exception ex)
            {
                return false;
        ...
        //Selecionando uma lista de usuarios no banco
        public IEnumerable<User> SelectListUser()
        {
            try
            {
                /*Nesse caso voce não precisa fazer a query 
        ...
        //Selecionando um usuario no banco
        ...
        public List<User> SelectListUserWithRole()
        {
